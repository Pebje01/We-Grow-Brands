  ...
  return (
    <section className="min-h-[auto] md:min-h-screen lg:min-h-[110vh] xl:min-h-[115vh] bg-[#02362B] relative overflow-hidden flex flex-col pt-8 pb-10 md:pb-20 lg:pb-24 rounded-b-[20px] md:rounded-b-[30px] mb-6 md:mb-0">
      ...
      <div ref={containerRef} className="absolute inset-0 pointer-events-none">
        ...
        <div
          data-parallax="1.2"
          className="hidden xl:block absolute left-[15vw] bottom-[-3vw] w-[40vw] max-w-[1150px] aspect-[5/3] rounded-[1.6vw] bg-[#1a1a1a] border-4 border-[#2a2a2a] shadow-[0_30px_100px_rgba(0,0,0,0.3)]"
        >
          {/* Browser dots */}
        ...
        <div
          data-parallax="2"
          className="hidden xl:block absolute left-[59vw] bottom-[-7vw] w-[13vw] max-w-[360px] aspect-[9/19] rounded-[2.4vw] bg-[#1a1a1a] border-4 border-[#2a2a2a] shadow-[0_25px_80px_rgba(0,0,0,0.3)] z-10"
        >
          {/* Notch */}
        ...
        <div
          data-parallax="1.5"
          className="hidden xl:block absolute left-[73.5vw] bottom-[1vw] w-[11vw] max-w-[320px] aspect-[9/19] rounded-[2.4vw] bg-[#1a1a1a] border-4 border-[#2a2a2a] shadow-[0_25px_80px_rgba(0,0,0,0.3)]"
        >
          {/* Notch */}
          <div className="absolute top-2 left-1/2 -translate-x-1/2 w-10 h-1.5 rounded-full bg-[#333]"></div>
          {/* Screen content */}
