...
export default function CTA() {
  return (
 <section className="bg-cream py-24 px-8 text-center">  <div className="max-w-2xl mx-auto">  <h2 className="text-text-dark mb-6">  <span className="font-serif ">Begin uw</span>{' '}  <span className="serif-header">digitale transformatie</span>         </h2>
 ...
 className="btn-spring btn-uniform link-wave bg-green-dark text-white hover:bg-lila hover:text-green-dark transition-all"           >
          ...
          <Link
            href="#diensten"
 className="btn-spring btn-uniform link-wave bg-lila text-green-dark hover:bg-[#D6BCFF] hover:text-green-dark transition-all"           >
 ...
 <div className="bg-green-dark rounded-2xl px-8 py-6 inline-flex items-center gap-4">  <span className="text-white/80 text-sm">💬 Nog niet zeker? Stel een snelle vraag via WhatsApp</span>           <Link
            href="#"
 className="btn-spring btn-uniform link-wave bg-lila text-green-dark hover:bg-[#D6BCFF] hover:shadow-lg transition-all"           >
