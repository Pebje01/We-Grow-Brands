...
export default function Features() {
  return (
    <section id="features" className="bg-cream py-20 px-8">
      <div className="max-w-6xl mx-auto">
        {/* Feature 1 */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
          <div>
            <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl text-text-dark font-normal italic leading-tight mb-5">
              Strategische websites voor merkversterking
            </h2>
            ...
            <Link href="#" className="text-green-dark font-semibold text-sm inline-flex items-center gap-2 hover:gap-3 transition-all">
              Bekijk onze aanpak
          ...
          <div className="bg-green-dark rounded-3xl p-8 min-h-[350px]">
            <span className="bg-lila text-green-dark px-3 py-1.5 rounded-full text-xs font-semibold inline-block mb-4">
              ✨ Premium Kwaliteit
            </span>
            <h3 className="text-white font-serif text-2xl italic mb-3">Custom Design</h3>
            ...
            <div className="space-y-4">
              <div className="bg-lila-light p-5 rounded-xl">
                ...
                <p className="font-serif text-4xl text-green-dark">
                  98<span className="text-base text-text-muted font-sans">/100</span>
                </p>
              </div>
