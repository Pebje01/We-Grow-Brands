...
export default function Testimonials() {
  return (
 <section id="reviews" className="bg-green-dark py-24 px-8 rounded-[30px]">  <div className="max-w-6xl mx-auto text-center">  <h2 className="text-white mb-12">  <span className="font-serif ">Ervaringen van </span>  <span className="serif-header text-lila">onze partners</span>         </h2>
