...
export default function Testimonials() {
  return (
    <section id="reviews" className="bg-green-dark py-24 px-8">
      <div className="max-w-6xl mx-auto text-center">
        <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl text-white font-normal italic mb-12">
          Ervaringen van <span className="text-lila">onze partners</span>
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {testimonials.map((testimonial, index) => (
            ...
            >
              <div className="text-lila text-sm mb-4">★★★★★</div>
              <p className="text-white/85 text-sm leading-relaxed italic mb-6">{testimonial.quote}</p>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-lila rounded-full flex items-center justify-center text-green-dark font-semibold text-sm">
